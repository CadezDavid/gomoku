...
public class Groznje {
    public static int groznje(Polje[][] plosca, Zetoni naVrsti) {
        ...
        int dobro = straightFour(plosca, nasprotnik) + three(plosca, nasprotnik) + brokenThree(plosca, nasprotnik)
                + two(plosca, nasprotnik) + five(plosca, nasprotnik) + twoAndTwo(plosca, nasprotnik)
                + threeAndOne(plosca, nasprotnik);
    ...
    private static int straightFour(Polje[][] plosca, Zetoni naVrsti) {
        ...
        return 800 * poisciVzorec(plosca, vzorec1) + 80 * poisciVzorec(plosca, vzorec2)
    ...
    private static int brokenThree(Polje[][] plosca, Zetoni naVrsti) {
        ...
        return 80 * poisciVzorec(plosca, vzorec1) + 8 * poisciVzorec(plosca, vzorec2);
    }
...
// + brokenThree(plosca, nasprotnik) + two(plosca, nasprotnik) + five(plosca,
// nasprotnik)
...
// Polje p = (naVrsti == Zetoni.CRNI ? Polje.BELI : Polje.CRNI);
// Polje[] vzorec = { p, p, p, p, p };
// return 1000000 * poisciVzorec(plosca, vzorec);
// }
//
// // straight four: _XXXX_
// private static int straightFour(Polje[][] plosca, Zetoni naVrsti) {
...
// Polje[] vzorec2 = { Polje.PRAZNO, p, p, p, p };
// Polje[] vzorec3 = { p, p, p, p, Polje.PRAZNO };
// return 80 * poisciVzorec(plosca, vzorec1) + 80 * poisciVzorec(plosca,
// vzorec2)
